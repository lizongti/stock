...
(
    select code from hive.stock.minutes_average where date = '2021-09-28' and time = '14:30' where higheast <= price
) minutes_average_1,
(
    select code from hive.stock.minutes_average where date = '2021-09-28' and time <= '14:30' group by code having sum(state) >= 200
) minutes_average_2,
(
...
and days.code = minutes_average_1.code
and days.code = minutes_average_2.code
